    ...
    <div className="flex flex-col lg:flex-row h-full overflow-hidden">
      ...
      >
        ...
        {/* Guest expiry reminder — the session passport TTL is the conversion
            hook. We show how long the choice will live and offer "Create an
            account" as the way to keep it permanently. Signed-in users never
            see this (their profile is the source of truth). */}
        {showGuestExpiryNote && (
